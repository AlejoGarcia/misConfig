...
" Vim transparent para controlar la transparencia de vim
...
nnoremap <leader>cl :w <CR> :! lua % <CR>
nnoremap <leader>cmm :w <CR> :! make <CR>
nnoremap <leader>cmr :w <CR> :! make run <CR>
nnoremap <leader>cmc :w <CR> :! make clear <CR>
nnoremap <leader>cmca :w <CR> :! make all <CR>
vnoremap . :norm.<CR>
imap jk <Esc>
...
nnoremap <leader>w> :vertical resize +10<CR>
inoremap <leader><Esc> \
inoremap <leader><leader>z <
inoremap <leader><leader>x >
